...
for oSetHolder in oSetsHoldersL:
	...
	setWithoutPlaceHolder = removeGroup.split(":")
	print setWithoutPlaceHolder[1]
	setToLoadName = setWithoutPlaceHolder[1].split("_")
	sAstName = setToLoadName[1]+"_"+setToLoadName[2]+"_"+setToLoadName[3]
	ast = DamAsset(proj,name=sAstName)
	mrcFile = ast.getResource("public", "render_ref")
	...
	if mrcFile:
		...
		print sNmspace
		oGlobalSRT = pm.PyNode(sNmspace + ":grp_geo")
