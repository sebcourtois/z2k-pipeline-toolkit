    ...
    def batch(self,*args, **kwargs):
        ...
        for scene in self.sceneL:
            ...
            if self.openInMaya in [True,1]:
                try:
                # open file / edit
                    path_private_toEdit=self.Z2K_ReleaseToolI.openAsset(sourceAsset=scene, SourceAssetType=self.SourceAssetType, readOnly=self.readOnly,)
            ...
            if self.prePublish_result and self.preRelease_result:
                ...
                try:
                    ...
                    self.printF(texta="ERROR_publish_release: \r\t{0}".format(err), openMode="a", printN=True)
                    self.outputD[scene]["ERROR_publish_release"]=  "\r\t{0}".format(err)
...
sourceFolder = "//Zombiwalk/z2k/06_PARTAGE/jp/ENVOI/ANGOULEME/151016_chr_previz_check/" #"Z:/06_PARTAGE/jp/ENVOI/150928/" test FINAL_PROPS_01
...
Z2K_ReleaseBatchI = Z2K_ReleaseBatch(  
    ...
    "C:/jipe_Local/00_JIPE_SCRIPT/PythonTree/RIG_WORKGROUP/tools/batchator_Z2K/scripts/testProject.py",
    "C:/jipe_Local/00_JIPE_SCRIPT/PythonTree/RIG_WORKGROUP/tools/batchator_Z2K/scripts/replaceAsset_batch_v001.py",
    ],

    preRelease_pyScriptL=[
    "C:/jipe_Local/00_JIPE_SCRIPT/PythonTree/RIG_WORKGROUP/tools/batchator_Z2K/scripts/Chr_previz_check_batch.py",
    ],
